...
<article class="post--item" itemtype="http://schema.org/Article" itemscope="itemscope">
    <div class="content">
        ...
        <div class="meta">
            <time itemprop="datePublished" datetime="<?php echo get_the_date('c'); ?>" class="humane--time"><svg class="icon" viewBox="0 0 1024 1024" width="16" height="16">
                ...
                </svg><?php echo get_the_date('Y-m-d'); ?></time>
