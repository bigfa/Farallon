<article class="post--item post--item__status" itemtype="http://schema.org/Article" itemscope="itemscope">
    <div class="content">
        <header><?php echo get_avatar(get_the_author_meta('ID', get_the_ID()), 48); ?><time itemprop="datePublished" datetime="<?php echo get_the_date('c'); ?>"><svg class="icon" viewBox="0 0 1024 1024" width="16" height="16">
